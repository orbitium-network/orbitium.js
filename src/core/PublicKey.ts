...
> {
  ...
  public address(): string {
    return bech32.encode('orb', bech32.toWords(this.rawAddress()));
  }

  public pubkeyAddress(): string {
    return bech32.encode('orbpub', bech32.toWords(this.encodeAminoPubkey()));
  }
}
...
> {
  ...
  public address(): string {
    return bech32.encode('orbvalcons', bech32.toWords(this.rawAddress()));
  }
