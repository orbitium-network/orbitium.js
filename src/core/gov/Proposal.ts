  ...
  export namespace Content {
    ...
    export function fromAmino(
      ...
      switch (amino.type) {
        ...
        case 'distribution/TreasuryPoolSpendProposal':
        case 'cosmos-sdk/TreasuryPoolSpendProposal':
          return TreasuryPoolSpendProposal.fromAmino(amino, isClassic);
        case 'distribution/FeeGrantPoolSpendProposal':
        case 'cosmos-sdk/FeeGrantPoolSpendProposal':
          return FeeGrantPoolSpendProposal.fromAmino(amino, isClassic);
    ...
    export function fromData(
      ...
      switch (data['@type']) {
        ...
        case '/orbitium.treasury.TreasuryProposal':
          return TreasuryPoolSpendProposal.fromData(data, isClassic);
        case '/orbitium.treasury.FeeGrantProposal':
          return FeeGrantPoolSpendProposal.fromData(data, isClassic);
    ...
    export function fromProto(
      ...
      switch (typeUrl) {
        ...
        case '/orbitium.treasury.TreasuryProposal':
          return TreasuryPoolSpendProposal.unpackAny(anyProto, isClassic);
        case '/orbitium.treasury.FeeGrantProposal':
          return FeeGrantPoolSpendProposal.unpackAny(anyProto, isClassic);
        case '/cosmos.params.v1beta1.ParameterChangeProposal':
