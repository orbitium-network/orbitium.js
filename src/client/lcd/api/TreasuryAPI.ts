...
export class TreasuryAPI extends BaseAPI {
  ...
  public async getTresuryBalance(): Promise<Coin> {
    return this.c
      .get<{ balance: Coin }>(`/orbitium/treasury/get_treasury_balance`)
      .then(d => d.balance);
  }

  public async getFeeGrantBalance(): Promise<Coin> {
    return this.c
      .get<{ balance: Coin }>(`/orbitium/treasury/get_fee_grant_balance`)
      .then(d => d.balance);
  }
  ...
  public async seigniorageProceeds(params: APIParams = {}): Promise<Coin> {
    ...
    return this.c
      ...
      .then(d => new Coin('uorb', d.seigniorage_proceeds));
  }
