...
export interface OracleParams {
  /** Number of blocks that define the period over which new votes must be submitted for the exchange rate of uorb. */
  vote_period: number;
...
export class OracleAPI extends BaseAPI {
  ...
  /**
   * Gets the Oracle module's currently registered exchange rate for uorb in all available denominations.
   */
   ...
   * @param denom denomination in which to get the exchange rate of uorb
   */
